  ...
  return (
    ...
    >
      ...
      <div className="relative mx-auto max-w-3xl px-6 pt-16 lg:px-0">
        <div className="rounded-[2rem] border border-sky-900/10 bg-white p-10 shadow-[0_24px_80px_rgba(15,23,42,0.08)]">
          <form className="space-y-10" onSubmit={(e) => e.preventDefault()}>
            <div className="grid gap-8 md:grid-cols-2">
              {[
                ...
                <div key={field.id} className="relative border-b border-sky-900/10 transition-colors focus-within:border-sky-700">
                  ...
                  <label htmlFor={field.id} className="absolute left-0 top-3 text-sm uppercase tracking-[0.25em] text-slate-500 transition-all duration-300 peer-focus:-top-4 peer-focus:text-[10px] peer-focus:text-sky-700 peer-not-placeholder-shown:-top-4 peer-not-placeholder-shown:text-[10px]">
                    {field.label}
                  </label>
                </div>
              ))}
            ...
            <div className="relative border-b border-sky-900/10 transition-colors focus-within:border-sky-700">
              ...
              <label htmlFor="message" className="absolute left-0 top-3 text-sm uppercase tracking-[0.25em] text-slate-500 transition-all duration-300 peer-focus:-top-4 peer-focus:text-[10px] peer-focus:text-sky-700 peer-not-placeholder-shown:-top-4 peer-not-placeholder-shown:text-[10px]">
                Tell us about your event
              </label>
            </div>

            <div className="flex justify-center pt-4">
              <button type="submit" className="rounded-full bg-sky-700 px-14 py-4 text-sm uppercase tracking-[0.25em] text-white transition hover:bg-sky-800">
                Send Message
              </button>
            </div>
          </form>
          ...
          <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
            {[...allPageImages.slice(0, 6)].map((image, index) => (
              <motion.div
                ...
                className="overflow-hidden rounded-[1.8rem] border border-sky-900/10 shadow-[0_16px_40px_rgba(15,23,42,0.06)]"
              >
                <ImageSlider
