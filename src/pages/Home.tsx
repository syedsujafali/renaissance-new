    ...
    >
      ...
      <section className="px-6 py-20 md:px-12 lg:px-16">
        <div className="mx-auto max-w-full space-y-10">
          <div className="rounded-[2rem] border border-[#003399]/10 bg-white p-8 shadow-[0_24px_80px_rgba(15,23,42,0.08)] md:p-12">
            <div className="space-y-6">
              <p className="text-xs uppercase tracking-[0.35em] text-[#003399]">Signature Work</p>
              ...
              <div className="flex flex-wrap gap-4">
                  <Link to="/portfolio" className="inline-flex items-center justify-center rounded-full border border-[#003399] bg-[#003399] px-8 py-3 text-sm uppercase tracking-[0.25em] text-white transition hover:bg-[#003399]">View Portfolio</Link>
                  <Link to="/about" className="inline-flex items-center justify-center rounded-full border border-[#003399]/10 bg-white px-8 py-3 text-sm uppercase tracking-[0.25em] text-[#003399] transition hover:bg-[#003399]/10">Our Story</Link>
              </div>
            </div>
          </div>
      ...
      <section className="px-6 pb-20 md:px-12 lg:px-16">
        <div className="mx-auto max-w-7xl">
          <div className="mb-14 text-center">
              <p className="mb-4 text-sm uppercase tracking-[0.35em] text-[#003399]">Featured Services</p>
          ...
          <div className="grid gap-6 sm:grid-cols-2 xl:grid-cols-4">
            {featuredHighlights.map((item) => (
              <motion.div
                ...
                transition={{ duration: 0.8 }}
                className="rounded-[2rem] border border-[#003399]/10 bg-white p-8 shadow-[0_16px_50px_rgba(15,23,42,0.05)]"
              >
      ...
      <section className="px-6 pb-24 md:px-12 lg:px-16">
        <div className="mx-auto max-w-7xl rounded-[2rem] border border-[#003399]/10 bg-white p-8 md:p-10">
          <div className="flex flex-col gap-6 md:flex-row md:items-end md:justify-between">
            <div>
              <p className="mb-3 text-xs uppercase tracking-[0.35em] text-[#003399]">Client Experience</p>
              <h3 className="font-serif text-3xl text-slate-800">A thoughtful process from first conversation to final reveal.</h3>
            </div>
            <button className="rounded-full border border-[#003399]/20 bg-white px-6 py-3 text-sm uppercase tracking-[0.25em] text-[#003399] transition hover:bg-[#003399]/10">Cookie Settings</button>
          </div>
        </div>
      </section>
    </motion.div>
